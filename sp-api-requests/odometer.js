...
(function() {
  ...
  Odometer = (function() {
    ...
    Odometer.prototype.animateSlide = function (newValue) {
      ...
      if (!(this.diff = newValue - oldValue)) {
          return;
      }
      ...
      for (i = _l = 0, _len1 = _ref.length; _l < _len1; i = ++_l) {
          ...
          switch (this.options.animation) {
              ...
              case 'byDigit':
                  let a = _ref[i][0]
                  let b = _ref[i][_ref[i].length-1]
                  if (this.options.directionByDigit) {
                      if (a > b) {
                          down = true;
                          frames = [...Array(10).keys()].slice(b,a+1).reverse()
                      } else {
          ...
          if ((this.options.animation !== 'minimal' && this.options.animation !== 'byDigit') || _ref[i][0] !== _ref[i][_ref[i].length-1] || oldValue == -newValue ) {
